...
GtkWidget *input1, *input2, *input3, *input5,*input4, *input_j, *input_m, *input_a, *input_annee;
...
input_m = lookup_widget(objet, "mois");
input_a = lookup_widget(objet, "annee");
input3=lookup_widget(objet,"entreteneur");
input4=lookup_widget(objet,"montant");
...
entr.date.jour = gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(input_j));
entr.date.mois = gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(input_m));
entr.date.annee = gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(input_a));
strcpy(entr.entreteneur,gtk_entry_get_text(GTK_ENTRY(input3)));
strcpy(entr.montant,gtk_entry_get_text(GTK_ENTRY(input4)));
strcpy(entr.reference,gtk_entry_get_text(GTK_ENTRY(input5)));
