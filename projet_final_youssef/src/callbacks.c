...
GtkWidget *quotidien= lookup_widget(dialog9,"arrosage1");
GtkWidget *hebdo= lookup_widget(dialog9,"arrosage_mois");
GtkWidget *mensuel= lookup_widget(dialog9,"arrosage_annee");
GtkWidget *coche= lookup_widget(dialog9,"checkbutton2");
...
////////////////////////////////////////////
GtkWidget *unit= lookup_widget(dialog9,"unite_modif");
GtkWidget *engrais= lookup_widget(dialog9,"engrais_modif");
...
gchar* commentaire;
	...
	{
/*gtk_tree_model_get (GTK_LIST_STORE (model), &iter, 0, &reference, 1, &Quantite, 2, &unite, 3, &date, 4, &Quantite1,5,&date_recolte, 6, &arrosage, 7, &engrais_ch,8,&date1, 9, &use, 10, &taille, 11, &date2, 12, &commentaire,-1);*/	
