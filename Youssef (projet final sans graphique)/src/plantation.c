...
GtkWidget *ref_p = lookup_widget (objet,"label127");
GtkWidget *ref_pm = lookup_widget (objet,"label_ref_modif");
GtkWidget *quant_m = lookup_widget (objet,"label131");
GtkWidget *quant = lookup_widget (objet,"label_quantite");
GtkWidget *input1=lookup_widget(objet,"label143");
GtkWidget *input2=lookup_widget(objet,"label133");
GtkWidget *input3=lookup_widget(objet,"label134");
GtkWidget *input1_m=lookup_widget(objet,"label144");
GtkWidget *input2_m=lookup_widget(objet,"label145");
GtkWidget *input3_m=lookup_widget(objet,"label146");
...
if (compare_date(p.date,p.date_recolte)){
		valide2=0;
		gtk_label_set_text(GTK_LABEL(input1),"date infèrieure");
		gtk_label_set_text(GTK_LABEL(input1_m),"date infèrieure");}
else {
		valide2=1;
...
if (verifREF_plante(p.reference) == 0){
		valide = 0;
		gtk_label_set_text(GTK_LABEL(ref_p),"reference existante");	
	}	
	else{
...
if (verifREF_plante(p.reference) == 0){
		valide = 0;
		gtk_label_set_text(GTK_LABEL(ref_pm),"reference existante");	
	}	
	else{
...
if (strcmp (p.reference,"") == 0) 
			{valide=0;
			gtk_label_set_text(GTK_LABEL(ref_p),"veuillez introduire une reference");
			gtk_label_set_text(GTK_LABEL(ref_pm),"veuillez introduire une reference");}
...
for (i=1;i<nb_annee;i++){
	...
	GtkWidget *ao_1=lookup_widget(window1,"label213");
	GtkWidget *m1_1=lookup_widget(window1,"label201");
	GtkWidget *m2_1=lookup_widget(window1,"label202");
	GtkWidget *m3_1=lookup_widget(window1,"label203");
	GtkWidget *m4_1=lookup_widget(window1,"label204");
	GtkWidget *m5_1=lookup_widget(window1,"label205");
	GtkWidget *m6_1=lookup_widget(window1,"label206");
	GtkWidget *m7_1=lookup_widget(window1,"label207");
	GtkWidget *m8_1=lookup_widget(window1,"label208");
	GtkWidget *m9_1=lookup_widget(window1,"label209");
	GtkWidget *m10_1=lookup_widget(window1,"label210");
	GtkWidget *m11_1=lookup_widget(window1,"label211");
	GtkWidget *m12_1=lookup_widget(window1,"label212");
	GtkWidget *moy13_1=lookup_widget(window1,"label214");
